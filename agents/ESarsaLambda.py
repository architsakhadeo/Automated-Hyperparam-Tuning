...
class ExpectedSarsaTileCodingContinuing():
    def __init__(self, tilings, tiles, lmbda, epsilon_init, alpha):
        self.number_tilings = tilings
        self.dim = tiles
        self.gamma = 0.95
        self.lmbda = lmbda
        self.epsilon_init = epsilon_init
        self.alpha = alpha
        self.stepsize = self.alpha / self.number_tilings
